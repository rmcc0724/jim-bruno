...
if ( ! class_exists( '__Tm_Elementor' ) ) {
	...
	class __Tm_Elementor {
		...
		public function edit_scripts() {
			...
			$js_core = singerella_theme()->get_core()->modules['cherry-js-core'];
			$ui      = singerella_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = singerella_theme()->get_core()->init_module( 'cherry-interface-builder' );
