...
if ( ! class_exists( 'Singerella_Widget_Area' ) ) {

	class Singerella_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'singerella_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'singerella_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'singerella_widget_area_classes', $classes, $area_id );
	...
	function singerella_widget_area() {
		return Singerella_Widget_Area::get_instance();
	}

	singerella_widget_area();
}
