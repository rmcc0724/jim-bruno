 ...
 */
add_filter( 'template_include', array( 'Singerella_Wrapping', 'wrap' ), 99 );
add_filter( 'singerella_wrap_base', 'singerella_wrap_base_cpts' );
 ...
 */
function singerella_template_path() {
	return Singerella_Wrapping::$main_template;
}
 ...
 */
function singerella_template_base() {
	return Singerella_Wrapping::$base;
}

if ( ! class_exists( 'Singerella_Wrapping' ) ) {
	...
	class Singerella_Wrapping {
		...
		/**
		 * Initialize new instance of Singerella_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'singerella_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Singerella_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Singerella_Wrapping();
		}
	}
}
 ...
 */
function singerella_wrap_base_cpts( $templates ) {
