(function($){
	...
	CherryJsCore.theme_script = {
		...
		smart_slider_init: function( self ) {
			$( '.singerella-smartslider' ).each( function() {
				var slider = $(this),
		...
		swiper_carousel_init: function ( self ) {
			...
			jQuery('.singerella-carousel').each( function() {
				var swiper = null,
		...
		subscribe_init: function( self ) {
			CherryJsCore.variable.$document.on( 'click', '.subscribe-block__submit', function( event ){
				...
				var $this       = $(this),
					...
					nonce      = form.find( 'input[name="singerella_subscribe"]' ).val(),
				...
				$.ajax({
					url: singerella.ajaxurl,
					type: 'post',
					dataType: 'json',
					data: {
						action: 'singerella_subscribe',
						mail: mail,
						nonce: nonce
					},
					error: function() {
		...
		main_menu: function ( self, target ) {
			...
			if ( 'undefined' !== typeof singerella &&
				 'undefined' !== typeof singerella.labels &&
				 'undefined' !== typeof singerella.labels[ 'hidden_menu_items_title' ] &&
				 '' !== singerella.labels.hidden_menu_items_title ) {
				 moreButtonText = singerella.labels.hidden_menu_items_title;
			}
		...
		to_top_init: function ( self ) {
			if ( $.isFunction( jQuery.fn.UItoTop ) ) {
				$().UItoTop({
					text: singerella.labels.totop_button,
					scrollSpeed: 600
				});
			}
		},
